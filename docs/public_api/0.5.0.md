...
The skills extension in ADR 0008 is a design proposal for Stage 1 skills
over MCP (`app/skills`, catalog-only resources, principal-scoped). It adds
no implemented catalog, configuration, or protocol methods to 0.5.0.
