...
`request_limit` at boot. Production additionally requires that the resolved
...
`migrations`, `registry`, `hosts`, `origins`, `rate_limit_store`, `package`,
and `legacy_endpoint`. JSON uses schema
